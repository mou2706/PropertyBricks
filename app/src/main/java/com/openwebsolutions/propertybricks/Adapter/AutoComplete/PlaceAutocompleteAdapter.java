package com.openwebsolutions.propertybricks.Adapter.AutoComplete;
...
//                        Toast.LENGTH_SHORT).show();
    ...
    public class PlaceViewHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceViewHolder(View itemView) {
            ...
            mAddress = (TextView) itemView.findViewById(R.id.address1);
        }
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence description,CharSequence secondary) {
