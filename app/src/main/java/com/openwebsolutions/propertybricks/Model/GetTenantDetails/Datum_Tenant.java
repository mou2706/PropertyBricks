...
public class Datum_Tenant {
    ...
    private Tenant_Property property;
    /**
    ...
    /**
     *
     * @param tenantOwnerAddress
     * @param image
     * @param tenantOwnerPhone
     * @param tenantOwnerEntrydate
     * @param updatedAt
     * @param id
     * @param property_id
     * @param compGstin
     * @param createdAt
     * @param tenantOwnerEmail
     * @param tenantOwnerPaymentcycle
     * @param deletedAt
     * @param tenantOwnerName
     * @param billingAddress
     */
    public Datum_Tenant(Integer id, Integer property_id, String tenantOwnerName, String tenantOwnerPhone, String tenantOwnerEmail, String tenantOwnerAddress, String tenantOwnerEntrydate, Integer tenantOwnerPaymentcycle, String compGstin, String billingAddress, String image, String createdAt, String updatedAt, Object deletedAt) {
        super();
        this.id = id;
    ...
    public Tenant_Property getProperty() {
        return property;
    }

    public void setProperty(Tenant_Property property) {
