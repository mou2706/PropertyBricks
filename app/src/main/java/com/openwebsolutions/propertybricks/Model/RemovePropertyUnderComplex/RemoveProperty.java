...
public class RemoveProperty {
    ...
    public RemoveProperty(Integer id, Integer userId, Integer complexId, String propertyName, String propertyLocation, String latitude, String longitude, String propertyDes, String propertyPrice, String image, String createdAt, String updatedAt, Object deletedAt) {
        super();
        this.id = id;
        this.user_id = userId;
