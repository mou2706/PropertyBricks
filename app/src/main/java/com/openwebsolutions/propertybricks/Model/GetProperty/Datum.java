...
public class Datum {
     ...
     * @param propertyPrice
     */
    public Datum(Integer id, String propertyName, String propertyLocation, String propertyDes, String propertyPrice, String image, String createdAt, String updatedAt, Object deletedAt,Tenant tenant) {
        super();
        this.id = id;
