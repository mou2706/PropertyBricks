...
public class DatumViewProperty {
    private Integer id;
    ...
    private TeanatView tenant;

    public DatumViewProperty() {
    }

    public DatumViewProperty(Integer id, Integer complexId, String propertyName, String propertyLocation, String latitude, String longitude, String propertyDes, String propertyPrice, String image, String createdAt, String updatedAt, Object deletedAt) {
        super();
        this.id = id;
    ...
    public TeanatView getTenant() {
        return tenant;
    }

    public void setTenant(TeanatView tenant) {
        this.tenant = tenant;
    }
