...
public class PropertyTenant_Edit {
    ...
    public PropertyTenant_Edit() {
    }

    public PropertyTenant_Edit(Integer id, Integer property_id, String tenantOwnerName, String tenantOwnerPhone, String tenantOwnerEmail, String tenantOwnerAddress, String tenantOwnerEntrydate, Integer tenantOwnerPaymentcycle, String compGstin, String billingAddress, String image, String createdAt, String updatedAt, Object deletedAt) {
        super();
        this.id = id;
